...
class User(UserMixin, db.Model):
    ...
    role                = db.Column(db.Enum("student", "teacher", "admin", name="user_role"), default="student")
    ...
    preferred_eos       = db.Column(db.Enum("pr", "srk", "vdw", "ideal", name="preferred_eos_type"), default="pr")
    theme               = db.Column(db.Enum("light", "dark", name="theme_type"), default="light")
